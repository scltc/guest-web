...
public final class LegoPortFactory
{
    public static LegoPort create(char port) throws InvalidPortException
    {
        switch (port)
        {
            case '1': return new LegoPort(LegoPort.INPUT_1);
            case '2': return new LegoPort(LegoPort.INPUT_2);
            case '3': return new LegoPort(LegoPort.INPUT_3);
            case '4': return new LegoPort(LegoPort.INPUT_4);
            case 'A': return new LegoPort(LegoPort.OUTPUT_A);
            case 'B': return new LegoPort(LegoPort.OUTPUT_B);
            case 'C': return new LegoPort(LegoPort.OUTPUT_C);
            case 'D': return new LegoPort(LegoPort.OUTPUT_D);
            default:
