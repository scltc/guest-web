...
import { Observable, iif, of, throwError, Subscription, pipe } from 'rxjs';
import { concatMap, delay, retryWhen } from 'rxjs/operators';
import { WebSocketSubject, WebSocketSubjectConfig, webSocket } from 'rxjs/websocket';

export interface xReconnectingWebSocketConfiguration<TMessage> extends WebSocketSubjectConfig<TMessage> {
...
export class xReconnectingWebSocket<TMessage> {
    ...
    constructor(configuration: xReconnectingWebSocketConfiguration<TMessage>) {
